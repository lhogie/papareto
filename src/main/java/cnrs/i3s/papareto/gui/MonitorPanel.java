...
public class MonitorPanel<A> extends JPanel implements PopulationListener<A, A>
{
	...
	public MonitorPanel()
	{
		...
		fitnessPlotter.getPlot().getSpace().getXDimension().getLegend()
				.setText("Number of generations");
		fitnessPlotter.getPlot().getSpace().getYDimension().getLegend()
		...
		operatorPlotter.getPlot().getSpace().getXDimension().getLegend()
				.setText("Number of generations");
		operatorPlotter.getPlot().getSpace().getYDimension().getLegend()
		...
		perfPlotter.getPlot().setFigure(new Figure());
		ConnectedLineFigureRenderer r = new ConnectedLineFigureRenderer();
		perfPlotter.getPlot().getFigure().addRenderer(r);
		perfPlotter.getPlot().getSpace().getLegend()
				.setText("Number of generations per second");
		perfPlotter.getPlot().getSpace().getXDimension().getLegend()
				.setText("Number of generations");
		perfPlotter.getPlot().getSpace().getYDimension().getLegend()
				.setText("Number of generations per second");
	...
	private void updatePerfPlotter(Population<A, A> p)
	{
		if (lastIteration != - 1)
		{
			...
			perfPlotter.getPlot().getFigure().addPoint(p.getNumberOfGenerations(),
					duration);
		}
	...
	private void updateOperatorFigure(Operator o, Population<A, A> p)
	{
		...
		operatorFigure.addPoint(p.getNumberOfGenerations(),
				(int) 1000 * o.getSuccessRate());
